package com.andyeseapps.treningsprogram_navigation;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavHostFragment myNavHosFragment = (NavHostFragment) getSupportFragmentManager()
        ...
        try {
            ...
            if (null != drawerLayout) {
                ...
                topLevelDestinations.add(R.id.programFragment);
