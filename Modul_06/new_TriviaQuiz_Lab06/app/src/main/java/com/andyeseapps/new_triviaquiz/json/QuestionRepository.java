...
public class QuestionRepository {
    private MutableLiveData<QuestionData> questionData = new MutableLiveData<>(new QuestionData(""));
    ...
    public MutableLiveData<QuestionData> getQuestionData() {
        return questionData;
    }
    ...
    public void download(Context context, String defaultUrlAPI) {
        ...
        Log.d("testing", "download in QuestionRepository ran...");
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                JSONObject questionJson = response.getJSONObject(i);
                                Question question = gson.fromJson(questionJson.toString(), Question.class);
                                tmpList.add(question);
                            }

                            QuestionData tmpQuestionData = new QuestionData(tmpList);
